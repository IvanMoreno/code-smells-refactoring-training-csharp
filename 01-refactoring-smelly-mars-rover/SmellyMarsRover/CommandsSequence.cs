...
public record CommandsSequence(IEnumerable<RoverCommand> Commands) : IEnumerable<RoverCommand> {
    public IEnumerator<RoverCommand> GetEnumerator() => Commands.GetEnumerator();
    IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();
    
    public static implicit operator CommandsSequence(string encodedCommands) => new(ParseCommands(encodedCommands));
