...
public class OurDateTest
{
    ...
    {
        var ourDate = OurDate.Create("1789/01/24");
        var sameDay = OurDate.Create("2001/01/24");
        var notSameDay = OurDate.Create("1789/01/25");
        var notSameMonth = OurDate.Create("1789/02/24");
